...
unsigned short _dictionary_insert(dictionary*, void*, char*);

//Look for an item in the dictionary _dictionary_lookup
void* _dictionary_lookup(dictionary*, char*);

//Remove an item from the dictionary.
unsigned short _dictionary_remove(dictionary*, char*, unsigned int);
